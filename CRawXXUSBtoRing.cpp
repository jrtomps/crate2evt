...
CRawXXUSBtoRing::CRawXXUSBtoRing(CRingBuffer* pBuffer)
...
*/
void
CRawXXUSBtoRing::processBuffer(ByteBuffer& buffer)
{
...
*/
bool CRawXXUSBtoRing::hasOptionalHeader()
{
 ...
 */
void 
CRawXXUSBtoRing::processEvents(ByteBuffer& inBuffer)
{
...
void CRawXXUSBtoRing::validateOptionalHeader(Deserializer<ByteBuffer>& buffer, size_t nWords)
{
 ...
 */
void
CRawXXUSBtoRing::outputTriggerCount(uint32_t runOffset)
{
...
bool CRawXXUSBtoRing::eventComplete(uint16_t header)
{
 ...
 */
void
CRawXXUSBtoRing::getTimestampExtractor()
{
